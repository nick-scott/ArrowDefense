...
public class EnvorinmentBuilder : MonoBehaviour{
    ...
    {
        hill.transform.position = new Vector3(Screen.width/2, (Screen.height / realPercentage)/2, transform.position.z);
        groundFill.transform.position = new Vector3(Screen.width/2, (Screen.height / realPercentage)/4, transform.position.z);
        hill.transform.localScale = new Vector3(Screen.width*1.4f, Screen.height / realPercentage/2, 1);
        groundFill.transform.localScale = new Vector3(Screen.width,( Screen.height / realPercentage)/2, 1);
